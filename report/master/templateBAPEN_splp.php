...
if ($jadwal_bap){
    ...
    if ($jadwal_bapx){
        ...
        $sql = $sql . "pemohon.nomor_surat, pemohon.keterangan, pemohon.tgl_penetapan, pemohon.keluaran_splp, ";
        ...
        if ($pem){
            ...
            $pemohon_keluaran_splp=$pem['keluaran_splp'];
...
echo '
  ...
  <tr>
    <td colspan="4"><div style="text-align:justify">-----Yang bersangkutan dimintai keterangan 
    sehubungan dengan diterbitkannya dokumen negara berupa SPLP Nomor 
    '. $pemohon_nomor_splp .' yang diterbitkan 
    '.$pemohon_keluaran_splp.' pada tanggal '. tanggalIndonesia($pemohon_tgl_terbit_splp) .' berlaku 
