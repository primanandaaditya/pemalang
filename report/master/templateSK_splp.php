...
echo '<table width="100%" border="0" align="center">
  ...
  <tr>
    ...
    <td valign="top">&nbsp;</td>
    <td valign="top">  b. </td>
    <td colspan="2" valign="top"><div align="justify">Surat Perjalanan Laksana Paspor Nomor '.$pem['nomor_surat'].', dikeluarkan di '.$pem['keterangan'] .' pada '. tanggalIndonesia($pem['tgl_terbit_splp']) .' berlaku sampai dengan '. tanggalIndonesia($pem['tgl_habis_splp']) .' atas nama '.$pem['nama_pemohon'].';</div></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    ...
    <div align="justify">Bahwa berdasarkan hal sebagaimana dimaksud pada huruf a dan b, kepada yang bersangkutan dapat diberikan  penggantian Paspor RI karena hilang (SPLP) sesuai dengan peraturan perundang-undangan yang berlaku; </div></td>
  </tr>
  <tr>
    <td>Mengingat</td>
    <td>:</td>
  ...
  <tr>
    ...
    <td valign="top">:</td>
    <td>&nbsp;</td>
    <td colspan="2" valign="top"><div align="justify">KEPUTUSAN KEPALA KANTOR IMIGRASI KELAS II PEMALANG TENTANG PENANGGUHAN / PERSETUJUAN PENGGANTIAN PASPOR RI KARENA HILANG (SPLP) BAGI WARGA NEGARA INDONESIA ATAS NAMA '.$pem['nama_pemohon'].';</div></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td valign="top">:</td>
    <td>&nbsp;</td>
    <td colspan="2" valign="top"><div align="justify">Membatalkan SPLP atas nama '.$pemohon_nama.' dengan Nomor '.$pem['nomor_splp'].' yang dikeluarkan '.$pem['keluaran_splp'].' pada tanggal '.tanggalIndonesia($pem['tgl_terbit_splp']).' berlaku sampai dengan '.tanggalIndonesia($pem['tgl_habis_splp']).';</div></td>
  </tr>
  <tr>
