...
echo '<table width="100%" border="0" align="center">
  ...
  NOMOR: _____________ &nbsp;TAHUN '. date('Y') .' </p>
      <p align="center">TENTANG<br />
        PENANGGUHAN  / PERSETUJUAN PENGGANTIAN PASPOR RI KARENA RUSAK BAGI WARGA NEGARA INDONESIA <br />
  ...
  <tr>
    ...
    <td valign="top">&nbsp;</td>
    <td valign="top">  b. </td>
    <td colspan="2" valign="top"><div align="justify">Bahwa berdasarkan hal sebagaimana dimaksud pada huruf a, kepada yang bersangkutan dapat diberikan penggantian Paspor RI karena rusak tanpa unsur kesengajaan sesuai dengan peraturan perundang-undangan yang berlaku; ;</div></td>
  </tr>
