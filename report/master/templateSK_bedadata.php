...
echo '<table width="100%" border="0" align="center">
  ...
  NOMOR: _____________ &nbsp;TAHUN '. date('Y') .' </p>
      <p align="center">TENTANG<br />
        PENANGGUHAN  / PERSETUJUAN PENGGANTIAN PASPOR RI KARENA PERBEDAAN DATA BAGI WARGA NEGARA INDONESIA <br />
  ...
  <tr>
    ...
    <td valign="top">&nbsp;</td>
    <td valign="top">  b. </td>
    <td colspan="2" valign="top"><div align="justify">Surat Penetapan Pengadilan Negeri Nomor : '.$pem['nomor_surat'].' , yang  diterbitkan '.$pem['keterangan'] .' tanggal '. tanggalIndonesia($pem['tgl_penetapan']) .';</div></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    ...
    <div align="justify">Bahwa berdasarkan hal sebagaimana dimaksud pada huruf a dan b, kepada yang bersangkutan disetujui diberikan penggantian Paspor RI karena perbedaan data sesuai dengan peraturan perundang-undangan yang berlaku;  </div></td>
  </tr>
  <tr>
    <td>Mengingat</td>
    <td>:</td>
  ...
  <tr>
    ...
    <td valign="top">:</td>
    <td>&nbsp;</td>
    <td colspan="2" valign="top"><div align="justify">Meyetujui kepada yang bersangkutan untuk menggunakan data diri yang sebenarnya, yaitu ______________________;</div></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
