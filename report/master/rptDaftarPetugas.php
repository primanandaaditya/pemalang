...
// Page header
    function Header()
    {
        ...
        $this->Cell(30);
        // Title
        $this->Cell(30,10,'DAFTAR PETUGAS',0,0,'L');
        ...
        $this->MultiCell($lebar_kolom_nip, 6, "NIP", 0,'C');


        //sebelum render cell header kolom keempat
        //set XY
        $this->SetXY($this->GetX() + $lebar_kolom_no + $lebar_kolom_nip + $lebar_kolom_nama, $topY);
        //cell header kolom keempat
        $this->MultiCell($lebar_kolom_jabatan, 6, "Jabatan", 0,'C');



        //sebelum render cell header kolom kelima
        //set XY
        $this->SetXY($this->GetX() + $lebar_kolom_no + $lebar_kolom_nip + $lebar_kolom_nama + $lebar_kolom_jabatan, $topY);
        //cell header kolom ke5
        $this->MultiCell($lebar_kolom_pangkat, 6, "Pangkat", 0,'C');
        ...
        //ditambah dengan 40 karena itu adalah lebar kolom 1 + kolom 2
        $this->Line($topX+$lebar_kolom_no+$lebar_kolom_nama + $lebar_kolom_nip,$topY, $topX+$lebar_kolom_no+$lebar_kolom_nip + $lebar_kolom_nama,$this->GetPageHeight()-15);


        //garis vertikal setelah kolom 4
        //ditambah dengan 40 karena itu adalah lebar kolom 1 + kolom 2
        $this->Line($topX+$lebar_kolom_no+$lebar_kolom_nama + $lebar_kolom_nip + $lebar_kolom_jabatan,$topY, $topX+$lebar_kolom_no+$lebar_kolom_nip + $lebar_kolom_jabatan + $lebar_kolom_nama,$this->GetPageHeight()-15);

        //garis vertikal setelah kolom 5
        //ditambah dengan 40 karena itu adalah lebar kolom 1 + kolom 2
        $this->Line($topX+$lebar_kolom_pangkat + $lebar_kolom_no+$lebar_kolom_nama + $lebar_kolom_nip + $lebar_kolom_jabatan,$topY, $topX+ $lebar_kolom_pangkat + $lebar_kolom_no+$lebar_kolom_nip + $lebar_kolom_jabatan + $lebar_kolom_nama,$this->GetPageHeight()-15);
...
while ($petugas = $stmt->fetch(PDO::FETCH_ASSOC)){
    ...
    //render cell kedua
    $pdf->MultiCell($lebar_kolom_nama, $tinggi_cell, $petugas['nama'], 0,false);
    ...
    //render cell ketiga
    $pdf->MultiCell($lebar_kolom_nip, $tinggi_cell, $petugas['nip'], 0,false);
    ...
    //y2 haruslah dikurangi dengan tinggi cell
    $pdf->SetXY($pdf->GetX() + $lebar_kolom_no + $lebar_kolom_nama + $lebar_kolom_nip, $pdf->GetY()-$tinggi_cell);

    //render cell ketiga
    $pdf->MultiCell($lebar_kolom_jabatan, $tinggi_cell, $petugas['jabatan'], 0,'');




    $pdf->SetXY($pdf->GetX() + $lebar_kolom_jabatan + $lebar_kolom_no + $lebar_kolom_nama + $lebar_kolom_nip, $pdf->GetY()-$tinggi_cell);

    //render cell ketiga
    $pdf->MultiCell($lebar_kolom_pangkat, $tinggi_cell, $petugas['pangkat'], 0,false);
